      ...
      <Box sx={{ width: '100%' }}>
        ...
        <TabPanel value={value} index={0}>
          ...
          <span className="MainText">
            ...
            가능합니다! 항공보안 인공지능을 이용해보세요. <br /> 사진을 찍을 수
            있는 <span className="textImportant">핸드폰</span>만 있으면 됩니다.
          </span>
          ...
          <Link to="/page3">
            {' '}
            <Button variant="outlined">셀프체크 시작하기</Button>{' '}
          </Link>
        </TabPanel>
        <TabPanel value={value} index={1}>
          <img src="img/cont2.svg" className="ImgCont" width="100" />
          <span className="MainText">
            꼭 가져가야 하는 물건이 있는데, <br />
            반입금지 규정은 너무 많고 복잡한가요? <br />
            디테일한 감정을 위해 크기 측정을 해보세요! <br />
            항공보안 인공지능이 함께합니다. <br />{' '}
            <span className="textImportant">여권, 혹은 A4용지</span>를
            준비해주세요.
          </span>
          ...
          <Link to="/page5">
            {' '}
            <Button variant="outlined">크기측정 시작하기</Button>{' '}
          </Link>
        </TabPanel>
        ...
        <TabPanel value={value} index={2}>
          ...
          <span className="MainText">
            ...
            <span className="textImportant">
              일정량 이상의 액체는 기내 반입이 금지
            </span>
            됩니다.
            <br />
