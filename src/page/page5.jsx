...
const Page5 = () => {
    ...
    return(
        <div className='pageWrap arrowWrap'>
            ...
            <h3><span className='red'>셀프 크기 체크는 반드시 모바일 또는<br />테블릿으로 진행해주세요!</span> <br />크기를 측정하고 싶은 물건을 <br />여권과 함께 책상 또는 바닥에 준비해주세요.</h3>
            ...
            <h3>카메라 화면에 준비된 필터에 맞게 <br />여권을 위치시키고 촬영하기 버튼을 클릭해주세요.<br />화면이 멈추고 크기 체크 시작 버튼이<br />활성화되면 버튼을 눌러주세요.<br />다시촬영 버튼을 클릭하면<br />화면이 다시 활성화되고 촬영하실 수 있습니다.</h3>
